...
<div class="sm wrap">
	<div class="intro">
		<h1 class="wp-heading-inline"><?php esc_html_e( 'Sermon Manager Revival Import/Export', 'sermon-manager-revival' ); ?></h1>
	</div>
	<div class="wp-list-table widefat">
		<p><?php esc_html_e( 'We have made it easy to backup, migrate or bring sermons from another plugin. Choose the relevant option below to get started.', 'sermon-manager-revival' ); ?></p>
		<div id="the-list">
			<div class="plugin-card card-import-sm">
				<div class="plugin-card-top">
					<img src="<?php echo esc_url( SM_URL ); ?>assets/images/import-sm.jpg" class="plugin-icon"
							alt="<?php esc_attr_e( 'Import from file', 'sermon-manager-revival' ); ?>">
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Import from file', 'sermon-manager-revival' ); ?>
						</h3>
					</div>
						...
						<ul class="plugin-action-buttons">
							<li>
								...
								if ( ! empty( $upload_dir['error'] ) ) :
									...
									<div class="error">
										<p>
											<?php esc_html_e( 'Before you can upload your import file, you will need to fix the following error:', 'sermon-manager-revival' ); ?>
										</p>
										<p>
											<strong>
								...
								<?php else : ?>
									<form enctype="multipart/form-data" id="sm-import-upload-form" method="post"
										...
										<input class="button" id="submit" type="submit" name="submit"
												value="<?php esc_attr_e( 'Import from file', 'sermon-manager-revival' ); ?>"/>
									</form>
							...
							<li><a href="" class=""
										aria-label="<?php esc_attr_e( 'More Details', 'sermon-manager-revival' ); ?>">
									<?php esc_html_e( 'More Details', 'sermon-manager-revival' ); ?>
								</a></li>
						</ul>
					</div>
					<div class="desc column-description">
						<p><?php esc_html_e( 'Import sermons from another Sermon Manager installation.', 'sermon-manager-revival' ); ?></p>
					</div>
				</div>
			</div>
			<div class="plugin-card card-export-sm">
				<div class="plugin-card-top">
					<img src="<?php echo esc_url( SM_URL ); ?>assets/images/export-sm.jpg" class="plugin-icon"
							alt="<?php esc_attr_e( 'Export to file', 'sermon-manager-revival' ); ?>">
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Export to file', 'sermon-manager-revival' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
							...
							<li><a href="" class=""
										aria-label="<?php esc_attr_e( 'More Details', 'sermon-manager-revival' ); ?>">
									<?php esc_html_e( 'More Details', 'sermon-manager-revival' ); ?></a></li>
						</ul>
					</div>
					<div class="desc column-description">
						<p><?php esc_html_e( 'Create an export for the purpose of backup or migration to another website.', 'sermon-manager-revival' ); ?></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="wp-list-table widefat">
		<h2><?php esc_html_e( 'Import From 3rd Party Plugins', 'sermon-manager-revival' ); ?></h2>
		<p><?php esc_html_e( 'You can import sermons from the following plugins into Sermon Manager', 'sermon-manager-revival' ); ?></p>
		<div id="the-list">
			<div class="plugin-card <?php echo SM_Import_SB::is_installed() ? '' : 'not-available'; ?>">
				...
				<div class="plugin-card-top">
					<img src="<?php echo esc_url( SM_URL ); ?>assets/images/import-sb.jpg" class="plugin-icon"
							alt="<?php esc_attr_e( 'Sermon Browser', 'sermon-manager-revival' ); ?>">
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Sermon Browser', 'sermon-manager-revival' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
							...
							<li>
								<a href="https://wpforchurch.com/my/knowledgebase/96/Importing.html#sermon-browser?utm_source=sermon-manager&utm_medium=wordpress"
										target="_blank"
										aria-label="<?php esc_attr_e( 'More Details', 'sermon-manager-revival' ); ?>">
									<?php esc_html_e( 'More Details', 'sermon-manager-revival' ); ?></a>
							</li>
						</ul>
					</div>
					<div class="desc column-description">
			...
			<div class="plugin-card <?php echo SM_Import_SE::is_installed() ? '' : 'not-available'; ?>">
				...
				<div class="plugin-card-top">
					<img src="<?php echo esc_url( SM_URL ); ?>assets/images/import-se.jpg" class="plugin-icon"
							alt="<?php esc_attr_e( 'Series Engine', 'sermon-manager-revival' ); ?>">
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Series Engine', 'sermon-manager-revival' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
	...
	<p class="description">
		<?php esc_html_e( 'Note: We recommend you create a backup of your current database just in case.', 'sermon-manager-revival' ); ?>
	</p>
</div>
