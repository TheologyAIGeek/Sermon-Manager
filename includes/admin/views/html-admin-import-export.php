...
<div class="sm wrap">
	<div class="intro">
		<h1 class="wp-heading-inline"><?php esc_html_e( 'Sermon Manager Revival Import/Export', 'sermon-manager-for-wordpress' ); ?></h1>
	</div>
	<div class="wp-list-table widefat">
		<p><?php esc_html_e( 'We have made it easy to backup, migrate or bring sermons from another plugin. Choose the relevant option below to get started.', 'sermon-manager-for-wordpress' ); ?></p>
		<div id="the-list">
			<div class="plugin-card card-import-sm">
				<div class="plugin-card-top">
					...
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Import from file', 'sermon-manager-for-wordpress' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
							<li>
								...
								<?php else : ?>
									...
									<span class="button activate-now" id="sm-import-trigger">
										<span>
											<?php esc_html_e( 'Import', 'sermon-manager-for-wordpress' ); ?>
										</span>
							...
							<li><a href="" class=""
									...
									<?php esc_html_e( 'More Details', 'sermon-manager-for-wordpress' ); ?>
								</a></li>
						</ul>
					</div>
					<div class="desc column-description">
						<p><?php esc_html_e( 'Import sermons from another Sermon Manager installation.', 'sermon-manager-for-wordpress' ); ?></p>
					</div>
				</div>
			</div>
			<div class="plugin-card card-export-sm">
				<div class="plugin-card-top">
					...
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Export to file', 'sermon-manager-for-wordpress' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
							<li>
								<a href="<?php echo esc_url( wp_nonce_url( esc_url_raw( wp_unslash( $_SERVER['REQUEST_URI'] ) ) . '&doimport=exsm', 'sm-import' ) ); ?>"
									...
									<?php esc_html_e( 'Export', 'sermon-manager-for-wordpress' ); ?>
								</a>
							</li>
							<li><a href="" class=""
										aria-label="<?php esc_attr_e( 'More Details', 'sermon-manager-for-wordpress' ); ?>">
									<?php esc_html_e( 'More Details', 'sermon-manager-for-wordpress' ); ?></a></li>
						</ul>
					</div>
					<div class="desc column-description">
						<p><?php esc_html_e( 'Create an export for the purpose of backup or migration to another website.', 'sermon-manager-for-wordpress' ); ?></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="wp-list-table widefat">
		<h2><?php esc_html_e( 'Import From 3rd Party Plugins', 'sermon-manager-for-wordpress' ); ?></h2>
		<p><?php esc_html_e( 'You can import sermons from the following plugins into Sermon Manager', 'sermon-manager-for-wordpress' ); ?></p>
		<div id="the-list">
			<div class="plugin-card <?php echo SM_Import_SB::is_installed() ? '' : 'not-available'; ?>">
				...
				<div class="plugin-card-top">
					...
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Sermon Browser', 'sermon-manager-for-wordpress' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
							<li><a href="<?php echo esc_url( wp_nonce_url( esc_url_raw( wp_unslash( $_SERVER['REQUEST_URI'] ) ) . '&doimport=sb', 'sm-import' ) ); ?>"
									...
									<?php esc_html_e( 'Import', 'sermon-manager-for-wordpress' ); ?></a>
							</li>
							<li>
								<a href="https://wpforchurch.com/my/knowledgebase/96/Importing.html#sermon-browser?utm_source=sermon-manager&utm_medium=wordpress"
										target="_blank"
										aria-label="<?php esc_attr_e( 'More Details', 'sermon-manager-for-wordpress' ); ?>">
									<?php esc_html_e( 'More Details', 'sermon-manager-for-wordpress' ); ?></a>
							</li>
						</ul>
					</div>
					<div class="desc column-description">
			...
			<div class="plugin-card <?php echo SM_Import_SE::is_installed() ? '' : 'not-available'; ?>">
				...
				<div class="plugin-card-top">
					...
					<div class="name column-name">
						<h3>
							<?php esc_html_e( 'Series Engine', 'sermon-manager-for-wordpress' ); ?>
						</h3>
					</div>
					<div class="action-links">
						<ul class="plugin-action-buttons">
	...
	<p class="description">
		<?php esc_html_e( 'Note: We recommend you create a backup of your current database just in case.', 'sermon-manager-for-wordpress' ); ?>
	</p>
</div>
