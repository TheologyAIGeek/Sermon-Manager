...
function wpfc_sermon_metaboxes() {
	...
	$sermon_details_meta = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Sermon Details', 'sermon-manager-revival' ),
	...
	$sermon_details_meta->add_field( array(
		'name'         => esc_html__( 'Date Preached', 'sermon-manager-revival' ),
		// translators: %s date format, effectively <code>d/m/Y</code> or the like.
		'desc'         => esc_html__( '(optional)', 'sermon-manager-revival' ) . '<br>' . wp_sprintf( esc_html__( 'format: %s', 'sermon-manager-revival' ), $date_format_label ),
		'id'           => 'sermon_date',
	...
	$sermon_details_meta->add_field( array(
		...
		'desc'             => wp_sprintf( esc_html__( 'Select the %1$s. Modify the %2$s %3$s.', 'sermon-manager-revival' ), strtolower( sm_get_taxonomy_field( 'wpfc_service_type', 'singular_name' ) ), strtolower( sm_get_taxonomy_field( 'wpfc_service_type', 'label' ) ), '<a href="' . admin_url( 'edit-tags.php?taxonomy=wpfc_service_type&post_type=wpfc_sermon' ) . '" target="_blank">here</a>' ),
	...
	$sermon_details_meta->add_field( array(
		'name' => esc_html__( 'Main Bible Passage', 'sermon-manager-revival' ),
		...
		'desc' => wp_sprintf( esc_html__( 'Enter the Bible passage with the full book names, e.g. %1$s Or multiple books like %2$s', 'sermon-manager-revival' ), '<code>' . esc_html__( 'John 3:16-18', 'sermon-manager-revival' ) . '</code><br>', '<code>' . esc_html__( 'John 3:16-18, Luke 2:1-3', 'sermon-manager-revival' ) . '</code>' ),
		'id'   => 'bible_passage',
		'type' => 'text',
	) );
	$sermon_details_meta->add_field( array(
		'name'    => esc_html__( 'Description', 'sermon-manager-revival' ),
		'desc'    => esc_html__( 'Type a brief description about this sermon, an outline, or a full manuscript', 'sermon-manager-revival' ),
	...
	$sermon_files_meta = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Sermon Files', 'sermon-manager-revival' ),
	...
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'Location of MP3', 'sermon-manager-revival' ),
		'desc' => esc_html__( 'Upload an audio file or enter an URL.', 'sermon-manager-revival' ),
		'id'   => 'sermon_audio',
		'type' => 'file',
		'text' => array(
	...
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'MP3 Duration', 'sermon-manager-revival' ),
		// translators: %s see msgid "hh:mm:ss", effectively <code>hh:mm:ss</code>.
		'desc' => wp_sprintf( esc_html__( 'Length in %s format (fill out only for remote files, local files will get data calculated by default)', 'sermon-manager-revival' ), '<code>' . esc_html__( 'hh:mm:ss', 'sermon-manager-revival' ) . '</code>' ),
	...
	$sermon_files_meta->add_field( array(
		...
		'type' => 'file',
		'text' => array(
			'add_upload_file_text' => esc_html__( 'Add File', 'sermon-manager-revival' ),
			// Change upload button text. Default: "Add or Upload File".
		),
	) );
	$sermon_files_meta->add_field( array(
		'name' => esc_html__( 'Bulletin', 'sermon-manager-revival' ),
		'desc' => esc_html__( 'Upload a pdf file or enter an URL.', 'sermon-manager-revival' ),
		'id'   => 'sermon_bulletin',
		'type' => 'file',
		'text' => array(
