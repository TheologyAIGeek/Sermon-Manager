...
class SM_Settings_Verse extends SM_Settings_Page { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound
	...
	public function __construct() {
		$this->id    = 'verse';
		$this->label = __( 'Verse', 'sermon-manager-revival' );
	...
	public function get_settings() {
							...
							default:
								foreach (
									...
									if ( SermonManager::getOption( 'verse_bible_version' ) === $value ) {
										...
										$setting['desc'] = __( 'Note: WordPress is not set to any Spanish variant. Reverted to ESV.', 'sermon-manager-revival' );
		...
		$settings = apply_filters( 'sm_verse_settings', array( // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
			...
			array(
				'title'    => __( 'Verse Popups', 'sermon-manager-revival' ),
				'type'     => 'checkbox',
				'desc'     => __( 'Disable verse popups', 'sermon-manager-revival' ),
				'desc_tip' => __( 'If this option is checked, the verses will not have a link and a popup anymore. But, you would be free to use any other service you want to use without interfering with Sermon Manager.', 'sermon-manager-revival' ),
				'id'       => 'verse_popup',
				'default'  => 'no',
			),
			array(
				'title'   => __( 'Bible Version for Verse Popups', 'sermon-manager-revival' ),
				'type'    => 'select',
				'desc'    => __( 'Default: ESV.', 'sermon-manager-revival' ),
			...
			array(
				'title'    => __( 'Verse In Sermons Widget', 'sermon-manager-revival' ),
				'type'     => 'checkbox',
				'desc'     => __( 'Show verse.', 'sermon-manager-revival' ),
				'desc_tip' => __( 'By checking this option, the verse in our WordPress widget will show up. Default unchecked.', 'sermon-manager-revival' ),
