...
## Changelog ##
### 2026.5.8 ###
* Fix: Add missing ABSPATH direct file access guard to includes/class-sm-roles.php
* Fix: Replace wp_is_valid_utf8() (requires WP 6.9) with mb_check_encoding() in export class for WP 6.0 compatibility
