...
if ( have_posts() ) :
	...
	echo apply_filters( 'taxonomy-wpfc_sermon_series-before-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
	...
	echo apply_filters( 'taxonomy-wpfc_sermon_series-after-sermons', '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
